...
apps = {
   ...
   terminal = "terminator",
--   browser = "chromium --high-dpi-support=1 --force-device-scale-factor=1.5",
   browser = "chromium",
...
local run_on_start_up = {
   "xrandr --output DP-1 --primary --mode 3840x2160 --scale 0.8x0.8 --pos 0x0 --rotate normal  --output DP-2 --mode 3840x2160 --scale 0.8x0.8 --pos 0x0 --rotate normal  --right-of DP-1 --output HDMI-1 --off --output VIRTUAL-1 --off",
